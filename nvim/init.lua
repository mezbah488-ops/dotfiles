    ...
    config = function()
      ...
      local servers = {
        ...
        texlab = {
          settings = {
            texlab = {
              -- 1. TURN OFF vimtex FEATURES
              build = {
                onSave = false, -- Let vimtex handle compilation with \ll
              },
              forwardSearch = {
                executable = nil, -- Disable texlab's forward search, use vimtex's \lv
              },

              -- 2. TURN ON texlab UNIQUE FEATURES
              chktex = {
                onOpenAndSave = true, -- Lint your file for errors
                onEdit = true, -- Lint as you type
              },
              inlayHints = {
                labelDefinitions = true, -- Show label names next to \label{}
                labelReferences = true, -- Show previews next to \ref{}
              },
              diagnostics = {
                ignoredPatterns = { 'Overfull', 'Underfull' }, -- Optional: silence noisy warnings
              },
            },
          },
        },
